...
TLDR: `library(consort)` is a great new package for creating CONSORT/patient flow diagrams in R. [Jump to example.](#diagram)

# Introduction

The easiest way to make a one-off diagram is using something with a graphical interface, such as Power Point, Omnigraffle, or Lucifcharts, just to name a few.
